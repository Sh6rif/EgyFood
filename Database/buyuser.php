...
// sql to create table
$sql = "CREATE TABLE If Not EXISTS UserOrder_PayVisa (
...
foreach ($product_id as $id) {
  $sql = "INSERT INTO UserOrder_PayVisa  VALUES ('$id','$Full_Name','$Phone_Number','$City','$Region','$cardnumber','$monthyear/01','$cvv')";
